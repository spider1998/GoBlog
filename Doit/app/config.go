...
type Config struct {
	...
	HTTPAddr  string `json:"http_addr" default:":8080"` // HTTP 服务地址

	//数据库配置
	Mysql string `json:"mysql" default:"root:123456@tcp(localhost:3306)/doit?charset=utf8"` // mysql DSN
	...
	//邮件配置
	Email string `json:"email" default:"2387805574@qq.com"`
	Epass string `json:"epass" default:"henuqnarpnucdjci"`
	Etype string `json:"etype" default:"smtp.qq.com"`
	Eport int    `json:"eport" default:"587"`
